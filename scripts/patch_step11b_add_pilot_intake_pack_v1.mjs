...
// --- generator script ---
const GEN = path.join("scripts", "generate_pilot_intake_pack_for_selected_operator_v1.mjs");

const GEN_SRC = `#!/usr/bin/env node
import fs from "node:fs";
import path from "node:path";
...
writeIfChanged(GEN, GEN_SRC);
try { fs.chmodSync(GEN, 0o755); } catch {}

// --- package.json ---
const PKG = "package.json";
const pkg = JSON.parse(read(PKG));
pkg.scripts ||= {};
pkg.scripts["ciag:intake"] ||= "node scripts/generate_pilot_intake_pack_for_selected_operator_v1.mjs";
